...
DataSetManager::DataSetManager() :testDataPercent(25), validationDataPercent(0), totalDataNum(0), totalTrainDataNum(0), totalTestDataNum(0) {
...
void DataSetManager::addData(std::string folderName, int classlabel) {
    ...
    cv::String folder = folderName.c_str();
...
void DataSetManager::distribute() {
    ...
    std::sort(rndIndex.begin(), rndIndex.end());
